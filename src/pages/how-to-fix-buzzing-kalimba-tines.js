      ...
      <div className="">
        <div className="p-3">
          <div className="bg-gray-50 mt-3 rounded-md p-3 card-css">
            <h2 className="container mx-auto text-gray-600">Have you heard your Kalimba suddenly buzzing on some of its key? Have you wondered how to fix it? Or you are now looking for the solution to fix your buzzing Kalimba? We are here to help you and give some tips that might have a higher chance of fixing it.</h2>
          </div>
        </div>
        <div className="p-3">
          <div className="bg-gray-50 mt-3 rounded-md p-3 card-css">
            <h1 className="container mx-auto text-gray-700 font-bold text-3xl mb-2">Wiggling</h1>
            <h2 className="container mx-auto text-gray-600">Yes you read it right, a simple movement from left to right and vice versa would sometimes fix the problem. There might be just something stuck between the tines and bridge, and moving it may removed them. If you succeed with this first step, then your lucky enough.</h2>
